...
function ajax_index(){
	...
	<h1>" . $tpl->_ENGINE_parse_body('{APP_ROUNDCUBE}')."</H1>\n
	<table style='width:100%'>
	<tr>
		<td valign='top'><img src='img/roundcube-original-logo.png'></td>
		<td valign='top'>
	...
	<br>
	". RoundedLightWhite("<div style='font-size:16px'><p>{about_roundcube}</p></div>")
...
function {$prefix}demarre(){
	...
	function LoadMainRoundCube(){
		YahooWinS(745,'roundcube.index.php?ajax-pop=yes','$title');
