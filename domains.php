...
if(isset($_GET["Internet_Domain_Add_New"])){Internet_Domain_Add_New();exit;}
if(isset($_GET["add_entity"])){add_entity();exit;}
if(isset($_GET["Tree_Delete_Domain"])){Tree_Delete_Domain();exit;}
if(isset($_GET["Tree_Internet_domain_save_transport"])){Tree_Internet_domain_save_transport();exit;}
if(isset($_GET["Tree_Internet_domain_delete_transport"])){Tree_Internet_domain_delete_transport();exit;}
if(isset($_GET["Tree_Internet_domain_add_transport"])){Tree_Internet_domain_add_transport();exit;}
...
if(isset($_GET["PrivilegesGroup"])){Tree_group_privileges();exit;}
...
if(isset($_GET["TreeUserMailBoxForm"])){TreeUserMailBoxForm();exit();}
