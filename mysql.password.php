...
function {$prefix}ChargeLogs(){
	...
	function ChangeMysqlPassword(){
		...
		document.getElementById('mysqldivForLogs').innerHTML='<center><img src=\"img/wait_verybig.gif\"></center>';
...
function popup(){
	...
	$html="<H1>{MYSQL_PASSWORD_USER}</H1>
	...
	<tr>
		...
		<td valign='top'><p class=caption>{MYSQL_PASSWORD_USER_TEXT}</p>". RoundedLightWhite("
			<table style='width:100%'>
				<tr>
					<td valign='top' class=legend nowrap>{username}:</td>
					<td valign='top'>". Field_text('username',null)."</td>
				</tr>
				<tr>
					<td valign='top' class=legend>{password}:</td>
					<td valign='top'>". Field_password('password',null)."</td>
				</tr>
				<tr>
