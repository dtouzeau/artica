...
function s_PopUpFull(url,l,h,mtitle){
	var PopupWindow=null;
	settings='width='+l +',height='+h +',location=no,directories=no,menubar=no,toolbar=no,status=yes,scrollbars=yes,resizable=yes,dependent=yes';
	PopupWindow=window.open(url,mtitle,settings);
	PopupWindow.focus();
	PopupWindow.moveTo(0,0);
	}         
...
function ParseForm(Form_name,pageToSend,return_box,noHidden,ReturnValues,idRefresh,uriRefresh,function_callback){
	...
	if(return_box==true){
                if (document.getElementById(idRefresh)){
                	document.getElementById(idRefresh).innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
                }
                if(uriRefresh){
...
function YahooWinS(width,uri,title,waitfor){
	document.getElementById('dialogS').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
        if(!width){width='300';}
...
function YahooWinT(width,uri,title,waitfor){
	if(!width){width='300';}
	document.getElementById('dialogT').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
    	if(!title){title='Windows';}
...
function YahooWin0(width,uri,title,waitfor){
	...
	document.getElementById('dialog0').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooWin(width,uri,title,waitfor){
        ...
        document.getElementById('dialog1').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
        if(waitfor){
        $(function(){$('#dialog1').dialog({autoOpen: true,modal:true,closeOnEscape: true,width: width+'px',title: title,position: 'top'}).load(uri);});
        }else{
...
function YahooWin2(width,uri,title,waitfor){
        ...
        document.getElementById('dialog2').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooSetupControl(width,uri,title,waitfor){
    ...
    document.getElementById('SetupControl').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function RTMMail(width,uri,title,waitfor){
    ...
    document.getElementById('RTMMail').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooWinBrowse(width,uri,title,waitfor){
    ...
    document.getElementById('Browse').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooWin3(width,uri,title,waitfor){
    	...
    	document.getElementById('dialog3').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooWin4(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('dialog4').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooWin5(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('dialog5').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooWin6(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('dialog6').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function LoadWinORG(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('WinORG').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function LoadWinORG2(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('WinORG2').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooLogWatcher(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('logsWatcher').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooUser(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('YahooUser').innerHTML='<div style="width:100%;background-color:white;height:auto"><center><img src="img/wait_verybig.gif"></center></div>';
...
function YahooSearchUser(width,uri,title,waitfor){
	if(!width){width='300';}
    	...
    	document.getElementById('SearchUser').innerHTML='<div style="width:100%;background-color:white;height:450px;"><center><img src="img/wait_verybig.gif"></center></div>';
...
function LoadUserSectionAjax(num){
	var user_id=document.getElementById('user_id').value;
        var uri='';
        if(document.getElementById('DnsZoneName')){uri='&zone-name='+ document.getElementById('DnsZoneName').value; }
        LoadAjax('userform','domains.edit.user.php?userid='+ user_id + '&ajaxmode=yes&section='+num+uri)
	}
...
function FindUser(){
    var id='';
    mem_search=0;    
    YahooSearchUser('700','domains.manage.users.index.php?SearchUserNull='+document.getElementById("finduser").value,document.getElementById("finduser").value);
    FindUserTimeout();
}
