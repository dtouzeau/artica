...
$page=CurrentPageName();
	...
	<td valign='top' width=50%>
		<div id='left_status'></div>
	</td>
	<td valign='top'>
		<div id=right_status></div>		
	</td>
	</tr>
</table>
...
<script>
	...
	var x_RightInfos= function (obj) {
		var tempvalue=obj.responseText;
		if(document.getElementById('right_status')){document.getElementById('right_status').innerHTML=tempvalue;}
		LeftInfos();
		}
	...
	function RightInfos(){
			...
			XHR.appendData('status','right');
			XHR.appendData('counter',counter);
			XHR.sendAndLoad('admin.index.php', 'GET',x_RightInfos);	
			}
