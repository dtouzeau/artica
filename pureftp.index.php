...
$html="<H1>{APP_PUREFTPD}</H1>	
<div id='main_config_pureftpd'>
$datas
</div>
";
...
<tr>
	<td $style align='right' nowrap valign='top'><strong>{enable_pureftpd}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{BrokenClientsCompatibility}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{NoAnonymous}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{AnonymousCanCreateDirs}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{AnonymousCantUpload}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{AntiWarez}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{AutoRename}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{DontResolve}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{DisplayDotFiles}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{ProhibitDotFilesWrite}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{ProhibitDotFilesRead}:</strong></td>
	...
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{MaxIdleTime}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('MaxIdleTime',$pure->main_array["MaxIdleTime"],'width:50px',null,null,'{MaxIdleTime_text}')."</td>
	</tr>	
	
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{MaxClientsNumber}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('MaxClientsNumber',$pure->main_array["MaxClientsNumber"],'width:50px',null,null,'{MaxClientsNumber_text}')."</td>
	</tr>	
	
	
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{MaxClientsPerIP}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('MaxClientsPerIP',$pure->main_array["MaxClientsPerIP"],'width:50px',null,null,'{MaxClientsPerIP_text}')."</td>
	</tr>	

	<tr>
	<td $style align='right' nowrap valign='top'><strong>{LimitRecursion}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('LimitRecursion',$pure->main_array["LimitRecursion"],'width:50px',null,null,'{LimitRecursion_text}')."</td>
	</tr>	
	
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{Max_Load}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('MaxLoad',$pure->main_array["MaxLoad"],'width:50px',null,null,'{MaxLoad_text}')."</td>
	</tr>		

	<tr>
	<td $style align='right' nowrap valign='top'><strong>{AnonymousBandwidth}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('AnonymousBandwidth',$pure->main_array["AnonymousBandwidth"],'width:50px',null,null,'{AnonymousBandwidth_text}')."</td>
	</tr>

	<tr>
	<td $style align='right' nowrap valign='top'><strong>{MaxDiskUsage}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('MaxDiskUsage',$pure->main_array["MaxDiskUsage"],'width:50px',null,null,'{MaxDiskUsage_text}')."%</td>
	</tr>

	<tr>
	<td $style align='right' nowrap valign='top'><strong>{PassivePortRange1}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('PassivePortRange1',$PassivePortRange1,'width:50px',null,null,'{PassivePortRange_text}')." <strong>Port</strong></td>
	</tr>		
	<tr>
	<td $style align='right' nowrap valign='top'><strong>{PassivePortRange2}:</strong></td>
	<td $style valign='top' colspan=2>" . Field_text('PassivePortRange2',$PassivePortRange2,'width:50px',null,null,'{PassivePortRange_text}')." <strong>Port</strong></td>
	</tr>	
