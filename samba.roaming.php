...
function popup(){
	...
	$html="<H1>{roaming_profiles}</H1>
	<table style='width:100%'>
	<tr>
		<td width=1% valign='top'><img src='img/logon-profiles-128.png'></td>
		<td valign='top'><p class=caption>{roaming_profiles_text}</p>
		<div id='roamingdiv'>
		$enable
		<div style='text-align:right'><hr><input type='button' OnClick=\"javascript:EnableProfileSamba();\" value='{edit}&nbsp;&raquo;'></div>
		</div>
		</td>
	</tr>
	</table>";
