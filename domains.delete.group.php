...
<tr>
	<td valign='top' width=99%>
		<table style='width:100%'>
			<tr>
				<td style='border-bottom:1px solid #CCCCCC'><strong style='font-size:16px;'>$group->groupName</strong></td>
			</tr>
			<tr>
				<td align='right'><strong style='font-size:11px' >ID:$group->group_id</strong></td>
			</tr>
			<tr>
				<td><strong style='font-size:12px'>". count($group->members)." {members}</strong></td>
			</tr>
			$delete_mailbox
			<tr>
			<tr>
				...
				<td align='right'>
					<hr>
					<input type='button' OnClick=\"javascript:ConfirmDeletionOfGroup();\" value='{confirm_deletion_of}:$group->groupName&nbsp;&raquo;' style='padding:10px'>
				</td>
			</tr>			
		</table>
	</td>
...
<p class=caption>{warning_delete_all_users}</p>
<div id='deletion'>
$user_infos
</div>
";
