...
function popup(){
	...
	$html="<H1>{APP_DEVICE_CONTROL}</H1>
	<p class=caption>{APP_DEVICE_CONTROL_TEXT}</p>
	".RoundedLightWhite("<div id='usblistbrowse' style='height:400px;width:100%;overflow:auto'></div>");	
