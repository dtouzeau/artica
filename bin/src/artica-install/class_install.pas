    ...
    monit:=tmonit.Create(SYS);
          ...
          if ParamStr(2)='p3scan' then begin
            ...
            if length(ParamStr(2))>0 then begin
               ...
               writeln('|zabbix|hamachi|kav4proxy|postfilter|vmtools|zarafa|zarafa-web|monit|wifi[proxy-pac|artica-notifier|mldonkey');
               exit();
            end;
    ...
    if not NetWorkAvailable then begin
       writeln('Warning, Network is unreachable, some services could not be start...');
        ...
        if length(ParamStr(2))>0 then begin
               ...
               writeln('|syslogger|zabbix|kav4proxy|postfilter|vmtools|zarafa|zarafa-web|monit|wifi|proxy-pac|artica-notifier|mldonkey');
               exit();
            end;
