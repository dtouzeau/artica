...
uses
  ...
  fail2ban,emailrelay,mldonkey,backuppc,kav4fs,ocsi,ocsagent,
    ...
    if not NetWorkAvailable then begin
       writeln('Warning, Network is unreachable, some services could not be start...');
        ...
        if length(ParamStr(2))>0 then begin
               ...
               writeln('|syslogger|zabbix|kav4proxy|postfilter|vmtools|zarafa|zarafa-web|monit|wifi|proxy-pac|artica-notifier|mldonkey|backuppc|kav4fs|ocsweb|ocsagent');
               exit();
            end;
