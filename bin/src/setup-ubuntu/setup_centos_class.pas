...
begin
   ...
   fpsystem('rpm -iv http://apt.sw.be/redhat/el5/en/i386/RPMS.dag/rpmforge-release-0.3.6-1.el5.rf.i386.rpm');
   fpsystem('/bin/rm -rf /tmp/packages.list');
...
if not libs.RPM_is_application_installed('wv') then begin
  ...
  { writeln('Checking.............: Adding back-ported postfix 2.5.5');
   ...
   fpsystem('rpm --import http://dag.wieers.com/rpm/packages/RPM-GPG-KEY.dag.txt');
