...
uses
  Classes, SysUtils
  { you can add units after this }, setup_ubuntu_class, distriDetect, setup_suse_class,
  setup_fedora_class, setup_centos_class, setup_mandrake_class,setup_libs,setup_archlinux_class,unix;
