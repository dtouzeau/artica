...
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/da_DK.UTF-8/LC_MESSAGES/zarafa.po -o da_DK.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/de_DE.UTF-8/LC_MESSAGES/zarafa.po -o de_DE.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/en_US.UTF-8/LC_MESSAGES/zarafa.po -o en_US.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/es_CA.UTF-8/LC_MESSAGES/zarafa.po -o es_CA.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/es_ES.UTF-8/LC_MESSAGES/zarafa.po -o es_ES.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/fi_FI.UTF-8/LC_MESSAGES/zarafa.po -o fi_FI.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/fr_BE.UTF-8/LC_MESSAGES/zarafa.po -o fr_BE.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/fr_FR.UTF-8/LC_MESSAGES/zarafa.po -o fr_FR.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/it_IT.UTF-8/LC_MESSAGES/zarafa.po -o it_IT.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/nl_NL.UTF-8/LC_MESSAGES/zarafa.po -o nl_NL.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/no_NO.UTF-8/LC_MESSAGES/zarafa.po -o no_NO.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/pt_BR.UTF-8/LC_MESSAGES/zarafa.po -o pt_BR.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/pt_PT.UTF-8/LC_MESSAGES/zarafa.po -o pt_PT.UTF-8/LC_MESSAGES/zarafa.mo');
l.add('/usr/bin/msgfmt /usr/share/zarafa-webaccess/server/language/sv_SE.UTF-8/LC_MESSAGES/zarafa.po -o sv_SE.UTF-8/LC_MESSAGES/zarafa.mo');
