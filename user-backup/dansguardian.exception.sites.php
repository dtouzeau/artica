...
$html="
	...
	<h1>$rulename::{ExceptionSiteList}</H1>
	<table style='width:100%'>
	<tr>
		<td valign='top'>
			<p class=caption>{ExceptionSiteList_explain}</p>
			<table style='width:100%'>
					<tr>
...
function main_rules_exceptionsitelist_list($rule_main,$noecho=0){
	...
	$categ=$categ . 
		...
		<td width=1%>" . imgtootltip('ed_delete.gif','{delete}',"exceptionsitelist_del('$hostname','$rule_main','$num')") ."</td>
		</tr>
		";
		}
	$categ=$categ . "</table>";
