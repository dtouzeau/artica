...
function LoadMailingList(){
	var ou=document.getElementById('SelectOuList').value;
	YahooWin('500','domains.edit.group.php?LoadMailingList='+ou);
	//LoadAjax('MembersList','domains.edit.group.php?LoadMailingList='+ou);
	}
...
function Change_group_settings(gpid){
	var ou=document.getElementById('ou').value;
	YahooWin(440,'domains.edit.group.php?FORM_GROUP=yes&ou='+ou+'&gpid='+gpid);	
	}
