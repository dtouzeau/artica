...
function postfix_tls_tabs(){
	...
	while (list ($num, $ligne) = each ($array) ){
		...
		$html[]= "<li><a href=\"$page?main=yes&tab=$num\"><span>$ligne</span></li>\n";
		}
	return "
...
function postfix_tls_certificate(){
	...
	<table>
		...
		<td align='left'>" . Field_text("stateOrProvinceName",$array["server_policy"]["stateOrProvinceName"])  . "</td>
		</tr>
		<tr>
		<td class=legend>{localityName}:</strong></td>
		<td align='left'>" . Field_text("localityName",$array["server_policy"]["localityName"])  . "</td>
		</tr>	
		<tr>
		...
		<td align='left'>" . Field_text("organizationName",$array["server_policy"]["organizationName"])  . "</td>
		</tr>				
		<tr>
		<td class=legend>{organizationalUnitName}:</strong></td>
		<td align='left'>" . Field_text("organizationalUnitName",$array["server_policy"]["organizationalUnitName"])  . "</td>
		</tr>	
		<tr>
		<td class=legend>{commonName}:</strong></td>
		<td align='left'>" . Field_text("commonName",$array["server_policy"]["commonName"])  . "</td>
		</tr>
		<tr>
		<td class=legend>{emailAddress}:</strong></td>
		<td align='left'>" . Field_text("emailAddress",$array["server_policy"]["emailAddress"])  . "</td>
		</tr>
		<tr>
