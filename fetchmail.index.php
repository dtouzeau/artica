...
$html="
	...
	<tr>
		...
		<tr>
		<td valign='top'>".
			Paragraphe('64-logs.png','{events}','{events_text}',"javascript:s_PopUpScroll('fetchmail.index.php?events=true',450,400);") ."
		</td>
		<td valign='top'>".
			Paragraphe('64-recycle.png','{update_now}','{update_fetchmail_now}',"javascript:ReloadFetchMail();") ."
		</td>		
		<td>&nbsp;</td>
		</tr>
...
function fetch_popup_enable(){
	...
	<tr>
		<td valign='top'><div id='fetchFormEnable'>
			" . Paragraphe_switch_img('{enable_fetchmail}','{enable_fetchmail_text}','enable_fetchmail',$artica->EnableFetchmail)."
		</div>
		</td>
		<td valign='top'><input type='button' value='{edit}&nbsp;&raquo&raquo;' OnClick=\"javascript:FetchMailEnable();\"><hr><br>
		<p class=caption>{fetchmail_about}</p>
	</tr>
	</table>
	";
