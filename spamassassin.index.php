...
function popup(){
	...
	echo "
	<div id=main_config_spamass style='width:100%;height:430px;overflow:auto'>
		<ul>". implode("\n",$html)."</ul>
	</div>
		<script>
...
<tr>
	...
	<td valign='top' style='border-left:1px solid #005447;padding:5px'><p>{trusted_networks_text}</p></td>
</tr>
</table>";
