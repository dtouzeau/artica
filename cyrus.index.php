...
function squatter_popup(){
	...
	$CyrusEnableSquatter=Paragraphe_switch_img('{enable}','{SQUATTER_SERVICE_EXPL}','CyrusEnableSquatter',$CyrusEnableSquatter);
	
	$table="<table style='width:100%'>
	<tr>
		<td class=legend>{squatter_reindex}:</td>
		<td>". Field_array_Hash($hhm,"CyrusSquatterRindex",$CyrusSquatterRindex)."&nbsp;mn</td>
	</tr>
	</table>
	...
	<tr>
	<hr>
		<td colspan=2 align='right'><input type='button' OnClick=\"javascript:SQUATTER_SAVE();\" value='{edit}&nbsp;&raquo;'></td>
	</tr>
	</table>
	</div>
	";
...
function main_tabs(){
	...
	$tab="<div id=main_config_cyrus style='width:100%;height:500px;overflow:auto'>
		<ul>". implode("\n",$html)."</ul>
	</div>
		<script>
