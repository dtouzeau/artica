...
function main_config(){
	...
	<tr>
		...
		<p class=caption>{ad_server_text}</p>
		<table style='width:100%'>
		<tr>
			<td align='right' style='font-weight:bold;font-size:12px'>{server_name}:</td>
			<td align='left'>" . Field_text('server_name',$ldap->ldap_host,'width:120px')."</td>
		</tr>
		<tr>
			<td align='right' style='font-weight:bold;font-size:12px'>{server_port}:</td>
			<td align='left'>" . Field_text('server_port',$ldap->ldap_port,'width:90px')."</td>
		</tr>		
		</table>
		</td>
	</tr>
	...
	<tr>
		...
		<p class=caption>{admin_dn_text}</p>
		<table style='width:100%'>
		<tr>
			<td align='right' style='font-weight:bold;font-size:12px' nowrap>{anonymous_access}:</td>
			<td align='left'>" . Field_checkbox("anonymous",1,$ldap->anonymous,"ADAnonymousCheck()")."</td>
		</tr>		
		<tr>
			<td align='right' style='font-weight:bold;font-size:12px' nowrap>{administrator}:</td>
			<td align='left'>" . Field_text('administrator',$ldap->ldap_admin,'width:360px;font-size:12px',null,null,null,false,null,$DISABLED)."</td>
		</tr>
		<tr>
			<td align='right' style='font-weight:bold;font-size:12px' nowrap>{password}:</td>
			<td align='left'>" . Field_password('password',$ldap->ldap_password,'width:120px;font-size:12px',null,null,null,false,null,$DISABLED)."</td>
		</tr>		
		<tr>
			<td align='right' style='font-weight:bold;font-size:12px' nowrap>{suffix}:</td>
			<td align='left'>" . Field_text('suffix',"$ldap->suffix",'width:320px;font-size:12px',null,null,null,false,null,false)."</td>
		</tr>		
		</table>
		</td>
	</tr>
...
function SaveSettings(){
	...
	$ad->ldap_admin=$admin;
	$ad->ldap_password=$_POST["password"];
